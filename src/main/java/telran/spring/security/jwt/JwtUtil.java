...
public class JwtUtil {
	...
	@Value("${app.security.jwt.expiration.period}")
	long expPeriod;
...
public String createToken(Map<String, Object> extraClaims, UserDetails userDetails) {
	...
	return Jwts.builder().addClaims(extraClaims).setExpiration(exp)
			.setIssuedAt(current).setSubject(userDetails.getUsername())
